        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                else
                {
                    ...
                    {
                        Console.WriteLine($"{name} cannot create anothe team!");
                    }
                    else
                    {
                        Team team = new Team();
            ...
            while (input != "end of assignment")
            {
                ...
                else if (teams.Any(x => x.Members.Contains(nameJoiners)) || teams.Any(x => x.Creator.Contains(nameJoiners)))
                {
